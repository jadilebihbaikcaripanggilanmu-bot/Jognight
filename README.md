...
- Saat aplikasi pertama dibuka, hanya layer CCTV yang aktif. Layer lain tetap tersedia di kontrol layer, tetapi tidak langsung dicentang supaya browser lebih ringan.
- Terjemahan petunjuk rute Indonesia/Jawa diperbaiki agar tidak banyak tercampur bahasa Inggris seperti `Turn left` atau `on Jalan ...`.
