...
const I18N = {
  id: {
    appTagline: 'Keamanan & Mobilitas Malam',
    ...
    searchWeb: 'Cari web',
    callHospital: 'Telpon RS',
    callOffice: 'Telpon kantor',
    callPolice: 'Telpon 110',
...
function buildOperationalLayers() {
  ...
  // Layer bantuan lain dibuat tetapi tidak langsung dicentang/ditampilkan.
  // Ini mencegah browser berat/crash saat pertama kali membuka WebGIS.
